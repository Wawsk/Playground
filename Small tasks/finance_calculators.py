...
# User choice on which part of the code to execute.
user_selection = input(">").lower()

# Start of the if statements.
# Incorrect input error handling.
if user_selection not in ("investment", "bond"):    
...
# Executes this part of the code if the user input states "investment".
    ...
    interest_rate = float(interest_rate) / 100  # Dividing early to make use in calculations
